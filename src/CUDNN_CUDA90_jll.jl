...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CUDNN_CUDA90_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("17e71f27-613d-5023-914f-287e042b5c33"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CUDNN_CUDA90", artifacts_toml) for e in artifacts["CUDNN_CUDA90"]]
...
if best_platform === nothing
    @debug("Unable to load CUDNN_CUDA90; unsupported platform $(triplet(platform_key_abi()))")
else
